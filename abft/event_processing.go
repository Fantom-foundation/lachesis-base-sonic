...
func (p *Orderer) checkAndSaveEvent(e ltypes.Event) (error, ltypes.FrameID) {
	// check frame & isRoot
...
func (p *Orderer) handleElection(selfParentFrame ltypes.FrameID, root ltypes.Event) error {
...
func (p *Orderer) forklessCausedByQuorumOn(e ltypes.Event, f ltypes.FrameID) bool {
...
func (p *Orderer) calcFrameIdx(e ltypes.Event) (selfParentFrame, frame ltypes.FrameID) {
	if e.SelfParent() == nil {
		return 0, 1
	}
